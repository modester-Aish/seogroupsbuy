      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {paginatedTools.map((tool, index) => (
            <div
              key={tool.name}
              className="bg-white border-2 border-blue-400 rounded-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-2"
            >
              ...
              <div className="bg-white p-4">
                <a
                  ...
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-4 rounded flex items-center justify-center transition-colors duration-200"
                >
